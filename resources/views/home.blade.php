...
@section('content')
        ...
        <section class="header" id="page">
            <div class="header-carousel owl-carousel owl-theme">
                <div class="sec-hero display-table" style="background-image: url(assets/images/header/benner.jpg)">
                ...
                <div class="sec-hero display-table" style="background-image: url(assets/images/header/benner2.jpg)">
                    <div class="table-cell">
                        <div class="overlay"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="banner">
                                        ...
                                        <h1 class="handline">Industry a variety of high quality products</h1>
                                        <p class="about-website">Gazolin Are A Industry &amp; Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry, Engineering, Construction And Any Related Industry Care Field.</p>
                                        <div class="btn-box">
                ...
                <div class="sec-hero display-table" style="background-image: url(assets/images/header/benner3.jpg)">
                    <div class="table-cell">
                        <div class="overlay"></div>
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="banner">
                                        ...
                                        <h1 class="handline">Provide Effective Building Solutions!</h1>
                                        <p class="about-website">Gazolin Are A Industry &amp; Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry, Engineering, Construction And Any Related Industry Care Field.</p>
                                        <ul class="header-list-features">
                                            <li class="item">
                                ...
                                <div class="col-sm-5 d-flex align-items-center justify-content-between">
                                    <div class="about-us-features-carousel owl-carousel owl-theme">
                                        <div class="item">
                                            ...
                                            <a class="btn-1 btn-3" href="01_about-us.html"><span>Read More</span></a>
                                        </div>
                                        <div class="item">
            ...
            <div class="container">
                ...
                <div class="services-carousel owl-carousel owl-theme">
                    <div class="services-carousel-item">
                        ...
                        <a class="btn-1 btn-3 open-link" href="01_services.html"><span>Read More</span></a>
                    </div>
                    <div class="services-carousel-item">
                        <i class="ar-icons-worker"></i>
                        <h4>Constraction of <br>Engineering</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim Magna.</p>
                        <a class="btn-1 btn-3 open-link" href="01_services.html"><span>Read More</span></a>
                    </div>
                    <div class="services-carousel-item">
        ...
        <section class="provide">
            ...
            <div class="container">
                <div class="sec-title">
                    <div class="row">
                        <div class="col-lg-5">
                            <h3>Gazolin Provide The Best Service For Sustainable Progress</h3>
                        </div>
                        <div class="col-lg-5 d-flex align-items-center">
                            <p class="sec-explain">Gazolin Are A Industry &amp; Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry, Engineering, Construction And Any Related Industry Care Field.</p>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="contact-box">
                                            ...
                                            <div class="box">
                                                <a class="phone" href="tel:0201212843661">0121284 3661</a>
                                                <a class="phone" href="tel:0201029134630">0102913 4630</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="statistic-item">
                            ...
                            <div class="content">
                                ...
                                <div class="counter-name">Projects And Residentials Completed in 2020</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
            ...
            <div class="container">
                <div class="sec-title">
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <h3>Gazolin Completed Some Project For Our Foreign Clients</h3>
                        </div>
                        <div class="col-lg-5 d-flex align-items-center">
                            <p class="sec-explain">Gazolin Are A Industry &amp; Manufacturing Services Provider Institutions. Suitable For Factory, Manufacturing, Industry, Engineering, Construction And Any Related Industry Care Field.</p>
                        </div>
                ...
                <div class="projects-carousel owl-carousel owl-theme">
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">Petrolum &amp; Gas, </a><a href="01_projects.html">Constraction</a></div>
                    ...
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">Constraction Engineering, </a><a href="01_projects.html">Building</a></div>
                                <h4><a href="01_projects.html">Building a sport city</a></h4>
                            </div>
                            <ul class="projects-icon">
                                <li><a href="01_projects.html"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">Gas Energy, </a><a href="01_projects.html">chemical</a></div>
                                <h4><a href="01_projects.html">Finix Gas Industry</a></h4>
                            </div>
                            <ul class="projects-icon">
                                <li><a href="01_projects.html"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">mechanical, </a><a href="01_projects.html">Engineering</a></div>
                                <h4><a href="01_projects.html">Gas &amp; Water dev project</a></h4>
                            </div>
                            <ul class="projects-icon">
                                <li><a href="01_projects.html"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">manufacturing, </a><a href="01_projects.html">industrial</a></div>
                                <h4><a href="01_projects.html">mantabo ball industry</a></h4>
                            </div>
                            <ul class="projects-icon">
                                <li><a href="01_projects.html"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="projects-item">
                        ...
                        <div class="hover-box">
                            <div class="text-box">
                                <div class="tags"><a href="01_projects.html">Constraction, </a><a href="01_projects.html">Building</a></div>
                                <h4><a href="01_projects.html">multi storied Building</a></h4>
                            </div>
                            <ul class="projects-icon">
                                <li><a href="01_projects.html"><i class="fas fa-link"></i></a></li>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="text-box">
                                ...
                                <a href="02_blog.html" class="btn-1 btn-3 link"><span>Read More</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="text-box">
                                ...
                                <span class="blog-date">Jan 25, 2022</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et dolore magna aliqua...</p>
                                <a href="02_blog.html" class="btn-1 btn-3 link"><span>Read More</span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="text-box">
                                ...
                                <span class="blog-date">Jan 30, 2022</span>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm tempor incididunt ut labore et dolore magna aliqua...</p>
                                <a href="02_blog.html" class="btn-1 btn-3 link"><span>Read More</span></a>
                            </div>
                        </div>
